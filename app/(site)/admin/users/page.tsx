...
export default function AdminPage() {
  ...
  return <div className="container mx-auto p-6">
      ...
      {accessCode && nextCodeDate && <div className="mb-4 p-4 border rounded-md bg-gray-100 text-sm">
      ...
      <Tabs value={tab} onValueChange={value => setTab(value as "users" | "approvals")}>
        <TabsList className="mb-6">
          ...
          <TabsTrigger value="approvals">
            Internal Approvals {pendingRequests.length > 0 && <span className="ml-2 inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-white bg-red-600 rounded-full">
