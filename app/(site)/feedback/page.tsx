...
const Feedback = () => {
  return <div className="min-h-screen bg-gradient-to-br from-gray-300 to-green-50 py-10 md:py-20 px-6 md:px-12 mt-20">
      <div className="max-w-6xl mx-auto bg-white shadow-xl rounded-3xl grid grid-cols-1 md:grid-cols-2 overflow-hidden">
        ...
        <div className="hidden md:flex items-center justify-center bg-gray-500">
          <img src="/images/feedback.svg" alt="Feedback Illustration" className="max-w-md w-full h-auto object-contain p-10" />
        </div>
      </div>
    </div>;
};
