...
weekStart.setDate(today.getDate() - today.getDay() + (today.getDay() === 0 ? -6 : 1)); // ✅ Forces Monday

const monthStart = new Date(today.getFullYear(), today.getMonth(), 1);
monthStart.setHours(0, 0, 0, 0); // ✅ Important fix
  ...
  if (
    userRole !== "staff" ||
    !userStream || // ensure it's defined
...
{/* <Button variant={activeQuickFilter === "month" ? "default" : "outline"} onClick={() => {
  applyDateRange(monthStart, new Date()); // ✅ Ensure range ends at today
