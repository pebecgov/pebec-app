            ...
            <strong>Completed</strong> – All steps completed
              ...
              width: `${project.progress}%`
                ...
                <div className="flex justify-between items-center mt-3">
                  ...
                  <Button variant="link" size="sm" className="text-green-600 text-xs p-0 h-auto" onClick={() => router.push(`/staff/projects/${project._id}`)}>
                    View Details
                  </Button>
                </div>
              </div>
            </div>) : <p className="text-sm text-zinc-500 col-span-3">No projects yet.</p>}
      </div>
    </div>;
}