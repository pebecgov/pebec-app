  ...
  return <div className="container mx-auto p-4 md:p-6">
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-4">
        <div className="relative p-4 w-[40px] h-[40px] hover:w-[250px] bg-green-700 rounded-full flex items-center transition-all duration-300">
          <input type="text" placeholder="Search for reports..." value={searchQuery} onChange={e => setSearchQuery(e.target.value)} className="outline-none bg-transparent text-white font-normal w-full pl-10" />
        </div>
