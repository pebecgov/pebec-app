...
export default function StateDLIsPage() {
  ...
  return <div className="p-6 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        ...
        return <Card key={dli._id} className="p-4 rounded-lg shadow-lg">
              ...
              <Button onClick={() => router.push(`/sub_national/dli/${dli._id}`)} className="mt-4 w-full bg-blue-600 text-white rounded-md">
                View Progress
              </Button>
            </Card>;
      })}
