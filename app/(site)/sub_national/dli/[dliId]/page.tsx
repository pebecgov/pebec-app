...
export default function StateDLIProgressPage() {
  ...
  const dliTemplate = useQuery(api.dli.getDliTemplate, { id: dliId as Id<"dli_templates"> }); // ✅ FIXED
  const userProgress = useQuery(api.dli.getUserDLIProgress, { dliTemplateId: dliId as Id<"dli_templates"> }); // ✅ FIXED
