...
export default function StateDLIProgressPage() {
  ...
  return <div className="max-w-4xl mx-auto p-4 md:p-6">
      {}
      <Button onClick={() => router.push("/vice_president/saber")} className="mb-6 flex items-center">
      ...
      <div className="space-y-6">
        ...
        return <div key={index} className="relative">
              ...
              <Card className={`relative z-10 p-4 shadow-sm rounded-xl transition-all
                ${isCompleted ? "bg-green-50 border-l-4 border-green-500" : "bg-white border border-gray-200"}`}>
