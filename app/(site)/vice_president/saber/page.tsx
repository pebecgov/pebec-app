...
export default function VicePresidentDLIAnalysis() {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      <h1 className="text-3xl font-bold mb-6">Vice Presidential DLI Step-by-Step Analysis</h1>
                          ...
                          <TableRow key={index}>
                            ...
                            <TableCell>
                              <Button 
                                size="sm" 
                                variant="outline"
                                onClick={() => window.location.href = `/vice_president/saber/${item.dliProgressId}`}
                              >
                                View DLI
                              </Button>
                            </TableCell>
