...
export default function SaberMaterialsPage() {
  ...
  return <div className="max-w-7xl mx-auto px-6 py-10">
      ...
      {userRole === "admin" && <div className="mb-6 w-full sm:w-64">
      ...
      {filteredMaterials ? <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {filteredMaterials.map(mat => <div key={mat._id} className="w-full bg-[#07182E] rounded-2xl overflow-hidden transition-all duration-300 hover:shadow-[0_0_30px_rgba(0,183,255,0.5)] flex flex-col min-h-[300px]">
