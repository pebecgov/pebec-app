...
export default function SubNational() {
  ...
  const reports = useQuery(api.internal_reports.getSubmittedInternalReports, user?._id ? {
  ...
  return <div className="mt-5 grid gap-6 max-w-6xl mx-auto px-4">
      {}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <Card className="p-4">
          ...
          <p className="text-md">
            {reports && reports.length > 0 ? format(new Date(reports[0].submittedAt), "PPP") : "No reports yet"}
          </p>
        </Card>
      </div>
