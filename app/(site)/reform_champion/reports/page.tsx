...
export default function ReportsPage() {
  ...
  📥 Download
                ...
                <Button className="bg-red-600 text-white px-3 py-1 flex items-center gap-1" onClick={() => exportToPDF(report, convexUser)}>
  📄 <span className="text-xs font-semibold">PDF</span>
                </Button>


  <Button className="bg-green-600 text-white px-3 py-1 flex items-center gap-1" onClick={() => exportToExcel(report)}>
