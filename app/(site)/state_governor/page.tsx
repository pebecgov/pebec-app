...
export default function StateDLIsPage() {
  ...
  return <div className="p-6 max-w-7xl mx-auto">
      {}
      {showWelcome && <div className="bg-green-100 border border-green-300 text-green-800 px-6 py-4 rounded-lg mb-6 relative shadow-md flex items-start justify-between">
          <div>
      ...
      <div className="text-center mb-6">
        {userData.state && <span className="bg-green-100 text-black-800 text-sm font-semibold px-4 py-1 rounded-full shadow inline-block mb-2">
