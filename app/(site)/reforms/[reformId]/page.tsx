...
// ✅ Define the Reform type properly
interface Reform {
  _id: Id<"reforms">;
  title: string;
  description: string;
...
// ✅ Assign Unique Icons to Impacts
...
export default function ReformDetailPage() {
  ...
  const imageUrl = useQuery(api.reforms.getImageUrl, reform?.imageId ? { storageId: reform.imageId } : "skip");
  ...
  return (
    <div className="container mx-auto p-6 mt-30">
      {/* ✅ Reform Banner Section with Dark Green Filter */}
      <div className="relative w-full h-[400px] md:h-[500px] overflow-hidden rounded-lg">
        {imageUrl && (
          <Image
            ...
            layout="fill"
            objectFit="cover"
            className="rounded-lg blur-sm brightness-50" // ✅ Blur effect + dark overlay
          />
        )}
              ...
              <DialogContent className="max-w-2xl">
                ...
                <div className="w-full">
                  <iframe
                    ...
                    src={reform.videoLink.replace("watch?v=", "embed/")} // ✅ Fix YouTube embedding
                    allowFullScreen
                  ></iframe>
                </div>
              </DialogContent>
      ...
      <div className="mt-12">
        ...
        {/* ✅ Impact Section - Using Accordions */}
         {/* ✅ Key Impacts Section */}
        ...
        <div className="mt-10 bg-white p-8 rounded-lg shadow-lg">
          ...
          <Accordion>
            {reform.impact.map((impact, index) => {
              const Icon = impactIcons[index % impactIcons.length]; // ✅ Assign rotating icons
      ...
      {/* ✅ Outcomes Section - Styled Dark Green */}
        {/* ✅ Outcome Section */}
