  ...
  return <>
        ...
        <div className="mx-auto max-w-c-1235 px-4 md:px-8 xl:px-0">
          <div className="flex items-center gap-8 lg:gap-32.5">
            ...
            once: true
              ...
              <Image src="/images/about/about-light-01.png" alt="About PEBEC" className="dark:hidden" fill />
              <Image src="/images/about/about-dark-01.png" alt="About PEBEC" className="hidden dark:block" fill />
            </motion.div>
            <motion.div variants={{
            hidden: {
              opacity: 0,
      ...
      <section>
        <div className="mx-auto max-w-c-1235 overflow-hidden px-4 md:px-8 2xl:px-0">
         ...
         <Image src="/images/business_reforms.jpg" alt="PEBEC Reforms" className="dark:hidden object-cover rounded-lg" layout="responsive" width={588} height={526} />
            <Image src="/images/business_reforms.jpg" alt="PEBEC Reforms" className="hidden dark:block object-cover rounded-lg" layout="responsive" width={588} height={526} />
