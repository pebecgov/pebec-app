...
export default function SocialMedia() {
  return <section className="my-16 px-4 max-w-6xl mx-auto">
      <motion.div className="flex flex-col-reverse md:flex-row items-center gap-10" initial={{
      opacity: 0,
      y: 30
    }} whileInView={{
      opacity: 1,
      ...
      once: true
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <div className="flex flex-wrap justify-center md:justify-start gap-4 mt-6">
            {socials.map((social, idx) => <a key={idx} href={social.href} target="_blank" rel="noopener noreferrer" className={`flex flex-col items-center justify-center w-36 h-32 rounded-lg ${social.color} text-white shadow hover:shadow-lg transition-shadow p-3`}>
        ...
        <div className="flex-1">
          <Image src="/images/social.svg" alt="Social Media Illustration" width={400} height={300} className="mx-auto" />
        </div>
      </motion.div>
    </section>;
}