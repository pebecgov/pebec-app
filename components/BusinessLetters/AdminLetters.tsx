...
const [activeLetterFiles, setActiveLetterFiles] = useState<{
  ...
  const openAssignDialog = () => {
    ...
    setAssignEntireStream(false); // default is false, toggle if needed
...
<div className="flex justify-end mb-4">
  ...
  onChange={(e) => {
    ...
    setAssignEntireStream(false); // ✅ Reset the checkbox when stream changes
    setSelectedStaffIds([]); // ✅ Reset selected staff when stream changes
  }}
...
>
  ...
  onClick={async () => {
    ...
    try {
      ...
      link.href = blobUrl;
      link.download = "Main_Letter.pdf"; // optional, you could make dynamic
