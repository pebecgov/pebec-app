...
import { useImageUpload } from "@/components/editor/image-upload"; // ✅ Import custom hook
...
export default function Editor({
  ...
  const [editorContent, setEditorContent] = useState<JSONContent>(
    post?.content ? JSON.parse(post.content) : defaultEditorContent
  );
      ...
      <EditorRoot>
        <EditorContent
          ...
          onUpdate={({ editor }) => {
            ...
            // ✅ Safe check to avoid undefined issue
            const imageNodes = jsonContent.content?.filter(
            ...
            if (setContent) setContent({ ...jsonContent, coverImageId }); // ✅ Save coverImageId with content
