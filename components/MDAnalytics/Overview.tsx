...
export default function MdaTicketsChart() {
  // ✅ Fetch Monthly Tickets Data for MDA
  ...
  const incidentsStats = useQuery(api.tickets.getMDAIncidentsStat) || {
    totalAssigned: 0,
    resolved: 0,
    closed: 0, // ✅ Make sure it defaults to 0
    unresolved: 0,
  ...
  const handleDownloadPDF = () => {
    ...
    // ✅ First Table: Monthly Ticket Statistics
    autoTable(doc, {
      startY: 20,
