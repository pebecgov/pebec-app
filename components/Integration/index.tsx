      ...
      <section>
        ...
        <div className="pattern-dots pattern-blue-500 pattern-bg-white pattern-size-4 pattern-opacity-10 relative z-50 mx-auto mt-15 max-w-c-1154 px-4 md:px-8 xl:mt-20 xl:px-0">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mt-10">
            ...
            description: "Simplified and expedited company registration process with CAC integration.",
            icon: <FaBuilding size={50} className="text-green-800" />
          }, {
            title: "Visa Reforms",
            description: "Implementation of an e-visa system for ease of travel and business operations.",
            icon: <FaPassport size={50} className="text-green-800" />
          }, {
            title: "Tax Payment System",
            description: "Digitized tax payment processes, making compliance seamless and transparent.",
            icon: <FaFileInvoiceDollar size={50} className="text-green-800" />
          }, {
            title: "Trade Facilitation",
            description: "Modernized port clearance and import/export procedures for efficiency.",
            icon: <FaExchangeAlt size={50} className="text-green-800" />
          }, {
            title: "Electricity Access",
            description: "Improved policies to ensure better access to power for businesses.",
            icon: <FaBolt size={50} className="text-green-800" />
          }, {
            title: "Regulatory Transparency",
            description: "Standardized procedures across agencies for business registration and compliance.",
            icon: <FaBalanceScale size={50} className="text-green-800" />
          }].map((reform, index) => <motion.div key={index} variants={{
            hidden: {
              opacity: 0,
              y: -20
            },
