  ...
  return <Dialog open={open} onOpenChange={onClose}>
      <DialogContent>
        ...
        <div className="grid gap-3">
          ...
          {allRoles.map(role => <label key={role} className="flex items-center gap-2">
        ...
        <div className="mt-6">
          ...
          <Select value={selectedReference || undefined} onValueChange={val => setSelectedReference(val as Reference)}>
            <SelectTrigger>
              <SelectValue placeholder="Select location" />
            </SelectTrigger>
            <SelectContent>
              {references.map(ref => <SelectItem key={ref} value={ref}>
