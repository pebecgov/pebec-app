...
export default function AnalyticsDashboard() {
  ...
  const handleDownloadExcel = () => {
    ...
    toast({ title: "Downloaded", description: "Excel file generated successfully!" });
  };
  ...
  const handleDownloadPDF = () => {
    ...
    toast({ title: "Downloaded", description: "PDF file generated successfully!" });
  };
