...
export default function TicketForm() {
  ...
  const [loading, setLoading] = useState(false);
   ...
   const role = useUserRole();
    ...
    // ✅ Show loading state until role is checked
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      await createTicket({
        ...form,
        incidentDate: new Date(form.incidentDate).getTime(), // Convert to timestamp
        supportingDocuments: [], // Future: Upload files to Convex storage
      });
