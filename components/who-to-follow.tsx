  ...
  return <Card className="flex-1">
      ...
      <CardContent>
        <ul className="flex flex-col gap-4">
          {upcomingEvents.length === 0 ? <p className="text-gray-500 text-sm">No upcoming events.</p> : upcomingEvents.map(event => <li key={event._id} className="flex items-start justify-between gap-4">
                <div className="inline-flex items-center gap-3">
                  {}
                  <Avatar className="w-12 h-12">
                    <AvatarImage src={event.coverImageUrl || '/placeholder.jpg'} alt={event.title} />
