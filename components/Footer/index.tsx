...
const Footer = () => {
  ...
  return <footer className=" bg-white md:mb-5 mb-30 dark:bg-black text-black dark:text-white border-t border-stroke dark:border-strokedark">
  ...
  <div className="flex flex-col lg:flex-row lg:justify-between lg:gap-20 gap-12">
    ...
    <motion.div variants={{
      ...
      <Link href="/" className="mb-4">
        <Image width={160} height={80} src="/images/logo/logo_pebec1.PNG" alt="PEBEC Logo" className="dark:hidden mx-auto lg:mx-0" />
        <Image width={140} height={90} src="/images/logo/logo-dark.svg" alt="PEBEC Logo" className="hidden dark:block mx-auto lg:mx-0" />
      </Link>
      ...
      <motion.div variants={{
        ...
        <form onSubmit={handleSubmit}>
          <div className="relative w-full">
            <input type="email" required value={email} onChange={e => setEmail(e.target.value)} placeholder="Email address" className="w-full rounded-full border border-stroke px-6 py-3 shadow focus:border-primary focus:outline-none dark:border-strokedark dark:bg-black" />
