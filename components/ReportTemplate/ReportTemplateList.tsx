...
export default function ReportTemplatesList() {
  ...
  const users = useQuery(api.users.getAllUsers, {}); // Make sure this function is defined in Convex


   // ✅ Map createdBy user ID to their full name
  ...
  const formattedTemplates = reportTemplates.map((template) => ({
    ...
    role: template.role,
    createdBy: template.createdBy as Id<"users">, // ✅ Fix Type Issue
