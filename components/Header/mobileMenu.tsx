...
const MobileMenu = () => {
  ...
  const userRoleText = userRole === "staff" && staffStream === "investments" ? "Investments Dashboard" : userRole === "staff" && staffStream === "receptionist" ? "Reception Desk" : userRole === "admin" ? "Admin" : userRole === "mda" ? "MDA Center" : userRole === "staff" ? "Staff Center" : userRole === "reform_champion" ? "Dashboard" : userRole === "deputies" ? "Dashboard" : userRole === "magistrates" ? "Dashboard" : userRole === "state_governor" ? "Dashboard" : userRole === "vice_president" ? "VP Dashboard" : userRole === "president" ? "President Dashboard" : userRole === "saber_agent" ? "Saber Dashboard" : "Dashboard";
