...
import MobileMenu from "./mobileMenu"; // Ensure correct import (case-sensitive)
...
import { FaCameraRetro } from "react-icons/fa"; // or any icon you prefer
...
const Header = () => {
  ...
  useEffect(() => {
    ...
    setResourcesDropdownOpen(false); // also close Resources menu
  }, [pathname]);

  useEffect(() => {
    setAboutDropdownOpen(false); // close dropdown on route change
  }, [pathname]);
 ...
 // ✅ Determine user role and set Dashboard link accordingly
