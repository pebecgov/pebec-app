...
const Header = () => {
  ...
  const userRoleText = userRole === "staff" && staffStream === "investments" ? "Investments Dashboard" : userRole === "staff" && staffStream === "receptionist" ? "Reception Desk" : userRole === "admin" ? "Admin" : userRole === "mda" ? "MDA Center" : userRole === "staff" ? "Staff Center" : userRole === "reform_champion" ? "Reform Champion" : userRole === "deputies" ? "Deputy Sheriffs" : userRole === "magistrates" ? "Magistrate Center" : userRole === "state_governor" ? "State Governor " : userRole === "vice_president" ? "VP Dashboard" : userRole === "president" ? "President Dashboard" : userRole === "saber_agent" ? "Saber Dashboard" : "Dashboard";
